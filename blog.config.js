...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，I‘m a CS student, Hi，I'm a UCCer,Hi，I'm a learner, welcome to myBlog🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Junjie', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'A CS student in UCC', // 作者简介
